...
export default function PersonalSection()
{
  ...
  return (
    <>
      <InputField label="Full Name" id="name" type="text" {...register("name", validationRules.name)} error={errors.name} isValid={!!dirtyFields.name && !errors.name} />
      ...
      <InputField label="E-Mail" id="email" type="email" {...register("email", validationRules.email)} error={errors.email} isValid={!!dirtyFields.email && !errors.email} />
    </>
  );
}
