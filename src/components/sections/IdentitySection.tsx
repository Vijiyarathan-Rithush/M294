  ...
  return (
    <>
      <InputField
        ...
        isValid={!!dirtyFields.dateOfBirth && !errors.dateOfBirth}
      />

      <UploadField
        label="Upload ID card (PNG/JPG/PDF, max. 5MB)"
        accept=".png,.jpg,.jpeg,.pdf"
        {...register("idConfirmation", validationRules.fileUpload)}
        error={errors.idConfirmation}
        isValid={!!dirtyFields.idConfirmation && !errors.idConfirmation}
      />
    </>
  )
}
