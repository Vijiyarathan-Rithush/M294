...
function ModalForm() {
  const { form, onSubmit, confirmPasswordRule, toast } = useRegistrationForm()
    ...
    <>
      ...
      <FormProvider {...form}>
        <form
          ...
          className="w-full grid grid-cols-1 md:grid-cols-2 gap-4 overflow-y-auto max-h-[80vh] md:max-h-[85vh]"
        >
          ...
          <div className="md:col-span-2 flex flex-col gap-2 sm:flex-row sm:justify-between">
            ...
            <ButtonField
              label={isSubmitting ? "Sende..." : "Absenden"}
